...
const PayPalButton = ({ total }) => {
  return (
    <PayPalScriptProvider options={{ "client-id": "sb", components: "buttons", "disable-funding": "venmo,paylater" }}>
      <PayPalButtons
        style={{
        ...
        onError={(err) => {
          console.error(err);
          message.error('Transaction failed. Please review your details and try again.');
        }}
      />
